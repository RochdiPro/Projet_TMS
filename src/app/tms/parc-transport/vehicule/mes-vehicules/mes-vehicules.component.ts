...
export class AjouterCarburantComponent {
  ...
  //constructeur
  constructor(public dialogRef: MatDialogRef<AjouterCarburantComponent>, public service: VehiculeService, public fb: FormBuilder, public _router: Router) {
...
export class AjouterVehiculeComponent implements OnInit {
  ...
  // constructeur
  constructor(public dialogRef: MatDialogRef<AjouterVehiculeComponent>, public fb: FormBuilder, public service: VehiculeService, public _router: Router) {
    this.form = this.fb.group({
  ...
  async enregistrerVehicule() { //enregistrer les données
    ...
    formData.append("charge_restante", this.form.get('chargeUtile').value);
    formData.append("surface_restante", (Number(this.form.get('longueur').value) * Number(this.form.get('largeur').value) * Number(this.form.get('hauteur').value)));
...
export class DetailVehiculeComponent implements OnInit {
  ...
  //constructeur
  constructor(public dialogRef: MatDialogRef<DetailVehiculeComponent>, public service: VehiculeService, public datepipe: DatePipe) {
  }
  ...
  async chargerEntretiensDuVehicule() {
    ...
    let description = ""
    this.entretiens = await this.service.getEntretiensVehicule(this.vehicule.id).toPromise();
    ...
    this.entretiens.forEach((entretien: any) => {
      ...
      if (entretien.liquideRefroidissement) description += "Vidange liquide de refroidissement\n";
      if (entretien.huileBoiteVitesse) description += "Vidange huile boite de vitesse\n";
      if (entretien.huileBoiteVitesse) description += "Vidange huile boite de vitesse\n";
      if (entretien.filtreHuile) description += "Changement filtre à huile\n";
      if (entretien.filtreAir) description += "Changement filtre à air\n";
      if (entretien.filtreClimatiseur) description += "Changement filtre de climatiseur\n";
      if (entretien.filtreCarburant) description += "Changement filtre de carburant\n";
  ...
  creerRapport() { //pour la creation du doccument a imprimer
    var carosserie = this.carosserie.filter(element => element.value === this.vehicule.categories);
    return {
      pageSize: 'A4',
      ...
      footer: function (currentPage: any, pageCount: any) {
        return {
          table: {
            body: [
              [
                { text: "Page" + currentPage.toString() + " de " + pageCount, alignment: 'right', style: 'normalText', margin: [490,35,0,0]}
              ]
            ]
          },
          layout: 'noBorders'
      ...
      content: [ //contenue du fichier PDF
        ...
        },
        {
          columns:[
            ...
            {
              text: this.vehicule.kilometrageProchainVidangeHuileMoteur - this.vehicule.kmactuel + ' Km',
              bold: true,
              margin: [76, 0, 0, 0],
              fontSize: 12
            },
        ...
        },
        {
          columns:[
            ...
            {
              text: this.vehicule.kilometrageProchainVidangeLiquideRefroidissement - this.vehicule.kmactuel + ' Km',
              bold: true,
              margin: [20, 0, 0, 0],
              fontSize: 12
            },
        ...
        },
        {
          columns:[
            ...
            {
              text: this.vehicule.kilometrageProchainVidangeHuileBoiteVitesse - this.vehicule.kmactuel + ' Km',
              bold: true,
              margin: [47, 0, 0, 0],
              fontSize: 12
            },
        ...
        },
        {
          columns:[
            ...
            {
              text: this.vehicule.kilometrageProchainChangementFiltreClimatiseur - this.vehicule.kmactuel + ' Km',
              bold: true,
              margin: [32, 0, 0, 0],
              fontSize: 12
            },
        ...
        },
        {
          columns:[
            ...
            {
              text: this.vehicule.kilometrageProchainChangementFiltreCarburant - this.vehicule.kmactuel + ' Km',
              bold: true,
              margin: [40.5, 0, 0, 0],
              fontSize: 12
            },
        ...
        },
        {
          columns:[
            ...
            {
              text: this.vehicule.kilometrageProchainChangementBougies - this.vehicule.kmactuel + ' Km',
              bold: true,
              margin: [70, 0, 0, 0],
              fontSize: 12
            },
        ...
        },
        {
          columns:[
            ...
            {
              text: this.vehicule.kilometrageProchainChangementCourroies - this.vehicule.kmactuel + ' Km',
              bold: true,
              margin: [62.5, 0, 0, 0],
              fontSize: 12
            },
        ...
        },
        {
          columns:[
            ...
            {
              text: this.vehicule.kilometrageProchainChangementPneus - this.vehicule.kmactuel + ' Km',
              bold: true,
              margin: [80, 0, 0, 0],
              fontSize: 12
            },
        ...
        },
        {
          columns:[
            ...
            {
              text: (((this.vehicule.montantConsomme / this.carburant.prixCarburant) / this.vehicule.distanceparcourie) * 100).toFixed(2) +'L/100Km',
              bold: true,
              margin: [157.5, 0, 0, 0],
              fontSize: 12
            },
        ...
        },
        {
          columns:[
            ...
            {
              text: this.datepipe.transform(this.vehicule.datevisite, 'dd/MM/y'),
              bold: true,
              margin: [101, 0, 0, 0],
              fontSize: 12
            },
        ...
        },
        {
          columns:[
            ...
            {
              text: this.datepipe.transform(this.vehicule.dateassurance, 'dd/MM/y'),
              bold: true,
              margin: [129, 0, 0, 0],
              fontSize: 12
            },
        ...
        this.table(this.listeEntretiensAfficher, ['date', 'kilometrage', 'lieuIntervention', 'description'])
      ],
    };
  }
...
export class MajVehiculeComponent implements OnInit {
  ...
  //constructeur
  constructor(public dialogRef: MatDialogRef<MajVehiculeComponent>, public fb: FormBuilder, public service: VehiculeService, public _router: Router) {
  }
  ...
  async ngOnInit() {
    ...
    this.form = this.fb.group({
      ...
      kmProchainVidangeHuileMoteur: [this.vehicule.kilometrageProchainVidangeHuileMoteur, [Validators.required, Validators.pattern("^[0-9]*$")]],
      kmProchainVidangeLiquideRefroidissement: [this.vehicule.kilometrageProchainVidangeLiquideRefroidissement, [Validators.required, Validators.pattern("^[0-9]*$")]],
      kmProchainVidangeHuileBoiteVitesse: [this.vehicule.kilometrageProchainVidangeHuileBoiteVitesse, [Validators.required, Validators.pattern("^[0-9]*$")]],
      kmProchainChangementFiltreClimatiseur: [this.vehicule.kilometrageProchainChangementFiltreClimatiseur, [Validators.required, Validators.pattern("^[0-9]*$")]],
      kmProchainChangementFiltreCarburant: [this.vehicule.kilometrageProchainChangementFiltreCarburant, [Validators.required, Validators.pattern("^[0-9]*$")]],
      kmProchainChangementBougies: [this.vehicule.kilometrageProchainChangementBougies, [Validators.required, Validators.pattern("^[0-9]*$")]],
      kmProchainChangementCourroies: [this.vehicule.kilometrageProchainChangementCourroies, [Validators.required, Validators.pattern("^[0-9]*$")]],
      kmProchainChangementPneus: [this.vehicule.kilometrageProchainChangementPneus, [Validators.required, Validators.pattern("^[0-9]*$")]],
...
export class MiseAJourConsommationComponent implements OnInit {
  ...
  //constructeur
  constructor(public dialogRef: MatDialogRef<MiseAJourConsommationComponent>, public fb: FormBuilder, public service: VehiculeService, public _router: Router) {
  }
  async ngOnInit() {
...
export class NotificationComponent implements OnInit {
  ...
  listeEntretien: any = []
  //consructeur
  constructor(public dialogRef: MatDialogRef<NotificationComponent>, public service: VehiculeService, public _router: Router) {
  }
  async ngOnInit() {
  ...
  testExistanceEntretien() { //teste s'il y a un entretien dans les 1000 prochains km
    let listeEntretien = [
      ...
      {
        type: 'Vidange liquide de refroidissement',
        kilometrage: this.vehicule.kilometrageProchainVidangeLiquideRefroidissement
      },
      {
        type: 'Vidange huile boite de vitesse',
      ...
      },
      {
        ...
        kilometrage: this.vehicule.kilometrageProchainChangementFiltreClimatiseur
      },
      {
    ...
    this.listeEntretien = listeEntretien.filter(entretien => (entretien.kilometrage - this.vehicule.kmactuel) < 1000)
...
export class ReclamationComponent implements OnInit {
  ...
  //constructeur
  constructor(public dialogRef: MatDialogRef<ReclamationComponent>, public fb: FormBuilder, public service: VehiculeService, public _router: Router) {
  }
...
export class BoiteDialogueEntretien implements OnInit {
  ...
  date: Date = new Date();
  valide = false
  constructor(private fb: FormBuilder, private dialogRef: MatDialogRef<BoiteDialogueEntretien>, @Inject(MAT_DIALOG_DATA) public data: any, public service: VehiculeService) { }
  ...
  ngOnInit() {
    this.form = this.fb.group({
      ...
      prochainVidangeLiquideRefroidissement: [{ value: '', disabled: true }, [Validators.required]],
  ...
  async valider() { //bouton valider pour lesubmit du form
    ...
    this.form.get('huileMoteur').value ? kilometrageProchainVidangeHuileMoteur = this.data.vehicule.kmactuel + this.form.get('prochainVidangeHuileMoteur').value : kilometrageProchainVidangeHuileMoteur = this.data.vehicule.kilometrageProchainVidangeHuileMoteur;
    this.form.get('liquideRefroidissement').value ? kilometrageProchainVidangeLiquideRefroidissement = this.data.vehicule.kmactuel + this.form.get('prochainVidangeLiquideRefroidissement').value : kilometrageProchainVidangeLiquideRefroidissement = this.data.vehicule.kilometrageProchainVidangeLiquideRefroidissement;
    this.form.get('huileBoiteVitesse').value ? kilometrageProchainVidangeHuileBoiteVitesse = this.data.vehicule.kmactuel + this.form.get('prochainVidangeHuileBoiteVitesse').value : kilometrageProchainVidangeHuileBoiteVitesse = this.data.vehicule.kilometrageProchainVidangeHuileBoiteVitesse;
    this.form.get('filtreClimatiseur').value ? kilometrageProchainChangementFiltreClimatiseur = this.data.vehicule.kmactuel + this.form.get('prochainChangementFiltreClimatiseur').value : kilometrageProchainChangementFiltreClimatiseur = this.data.vehicule.kilometrageProchainChangementFiltreClimatiseur;
    this.form.get('filtrCarburant').value ? kilometrageProchainChangementFiltreCarburant = this.data.vehicule.kmactuel + this.form.get('prochainChangementFiltrCarburant').value : kilometrageProchainChangementFiltreCarburant = this.data.vehicule.kilometrageProchainChangementFiltreCarburant;
    this.form.get('bougies').value ? kilometrageProchainChangementBougies = this.data.vehicule.kmactuel + this.form.get('prochainChangementBougies').value : kilometrageProchainChangementBougies = this.data.vehicule.kilometrageProchainChangementBougies;
    this.form.get('courroies').value ? kilometrageProchainChangementCourroies = this.data.vehicule.kmactuel + this.form.get('prochainChangementCourroies').value : kilometrageProchainChangementCourroies = this.data.vehicule.kilometrageProchainChangementCourroies;
    this.form.get('pneus').value ? kilometrageProchainChangementPneus = this.data.vehicule.kmactuel + this.form.get('prochainChangementPneus').value : kilometrageProchainChangementPneus = this.data.vehicule.kilometrageProchainChangementPneus;
    ...
    formdata.append('lieuIntervention', this.form.get('lieuIntervention').value)
    formdata.append('huileMoteur', this.form.get('huileMoteur').value)
    formdata.append('liquideRefroidissement', this.form.get('liquideRefroidissement').value)
    ...
    formdata2.append('kilometrageProchainVidangeHuileMoteur', kilometrageProchainVidangeHuileMoteur)
    formdata2.append('kilometrageProchainVidangeLiquideRefroidissement', kilometrageProchainVidangeLiquideRefroidissement)
    formdata2.append('kilometrageProchainVidangeHuileBoiteVitesse', kilometrageProchainVidangeHuileBoiteVitesse)
    formdata2.append('kilometrageProchainChangementFiltreClimatiseur', kilometrageProchainChangementFiltreClimatiseur)
    formdata2.append('kilometrageProchainChangementFiltreCarburant', kilometrageProchainChangementFiltreCarburant)
    formdata2.append('kilometrageProchainChangementBougies', kilometrageProchainChangementBougies)
    formdata2.append('kilometrageProchainChangementCourroies', kilometrageProchainChangementCourroies)
    formdata2.append('kilometrageProchainChangementPneus', kilometrageProchainChangementPneus)
    Swal.fire({
      title: 'Voulez vous enregistrer?',
      showCancelButton: true,
      confirmButtonText: 'Oui',
