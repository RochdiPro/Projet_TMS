...
export class AjouterVehiculeComponent implements OnInit {
  ...
  // constructeur
  constructor(public fb: FormBuilder, public service: VehiculeService, public router: Router) {
  ...
  async enregistrerVehicule() { //enregistrer les données
    ...
    if (typeMatriculeEstTUN) {  //tester le type de matricule selectionné pour l'enregistrer
      this.matricule = "";
      this.matricule = this.caracteristiquesFormGroup.get('serieVoiture').value.toString().concat("TUN");
      this.matricule = this.matricule.concat(this.caracteristiquesFormGroup.get('numeroVoiture').value.toString());
    } else if (typeMatriculeEstRS) {
      this.matricule = "";
      this.matricule = "RS".concat(this.caracteristiquesFormGroup.get('matriculeRS').value);
    }
    formData.append("matricule", this.matricule);
    formData.append("marque", this.caracteristiquesFormGroup.get('marque').value);
    formData.append("modele", this.caracteristiquesFormGroup.get('modele').value);
    formData.append("couleur", this.caracteristiquesFormGroup.get('couleur').value);
    formData.append("categories", this.categorie);
    formData.append("kmactuel", this.entretienEtPapierFormGroup.get('kmactuel').value);
    formData.append("kilometrageProchainVidangeHuileMoteur", this.entretienEtPapierFormGroup.get('kmProchainVidangeHuileMoteur').value);
    formData.append("kilometrageProchainVidangeLiquideRefroidissement", this.entretienEtPapierFormGroup.get('kmProchainVidangeLiquideRefroidissement').value);
    formData.append("kilometrageProchainVidangeHuileBoiteVitesse", this.entretienEtPapierFormGroup.get('kmProchainVidangeHuileBoiteVitesse').value);
    formData.append("kilometrageProchainChangementFiltreClimatiseur", this.entretienEtPapierFormGroup.get('kmProchainChangementFiltreClimatiseur').value);
    formData.append("kilometrageProchainChangementFiltreCarburant", this.entretienEtPapierFormGroup.get('kmProchainChangementFiltreCarburant').value);
    formData.append("kilometrageProchainChangementBougies", this.entretienEtPapierFormGroup.get('kmProchainChangementBougies').value);
    formData.append("kilometrageProchainChangementCourroies", this.entretienEtPapierFormGroup.get('kmProchainChangementCourroies').value);
    formData.append("kilometrageProchainChangementPneus", this.entretienEtPapierFormGroup.get('kmProchainChangementPneus').value);
    formData.append("consommationNormale", this.caracteristiquesFormGroup.get('consommationnormale').value);
    formData.append("montantConsomme", 0);
    formData.append("carburant", this.carburant.nom);
    formData.append("charge_utile", this.caracteristiquesFormGroup.get('chargeUtile').value);
    formData.append("longueur", this.caracteristiquesFormGroup.get('longueur').value);
    formData.append("largeur", this.caracteristiquesFormGroup.get('largeur').value);
    formData.append("hauteur", this.caracteristiquesFormGroup.get('hauteur').value);
    formData.append("charge_restante", this.caracteristiquesFormGroup.get('chargeUtile').value);
    formData.append("surface_restante", (Number(this.caracteristiquesFormGroup.get('longueur').value) * Number(this.caracteristiquesFormGroup.get('largeur').value) * Number(this.caracteristiquesFormGroup.get('hauteur').value)));
    formData.append("datevisite", new Date(this.entretienEtPapierFormGroup.get('datevisite').value));
    formData.append("dateassurance", new Date(this.entretienEtPapierFormGroup.get('dateassurance').value));
    formData.append("datetaxe", new Date(this.entretienEtPapierFormGroup.get('datetaxe').value));
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.router.navigateByUrl('/Menu/TMS/Parc/Vehicules/Mes-Vehicules/lister-vehicules');
      }
    })
  ...
  testTypeMatricule(): void { //tester le type de matricule si elle est TUN ou RS
    ...
    if (typeMatriculeEstTUN) { //si le type de matricule est TUN on definie les validateurs de ses inputFields et on supprime les validateurs du type RS
      ...
      this.caracteristiquesFormGroup.get('serieVoiture').setValidators([Validators.required, Validators.pattern("^[0-9]*$")])
      this.caracteristiquesFormGroup.get('serieVoiture').updateValueAndValidity();
      this.caracteristiquesFormGroup.get('numeroVoiture').setValidators([Validators.required, Validators.pattern("^[0-9]*$")])
      this.caracteristiquesFormGroup.get('numeroVoiture').updateValueAndValidity();
      this.caracteristiquesFormGroup.get('matriculeRS').setValidators([])
      this.caracteristiquesFormGroup.get('matriculeRS').updateValueAndValidity();
      ...
      this.caracteristiquesFormGroup.get('matriculeRS').setValidators([Validators.required, Validators.pattern("^[0-9]*$")])
      this.caracteristiquesFormGroup.get('matriculeRS').updateValueAndValidity();
      ...
      this.caracteristiquesFormGroup.get('numeroVoiture').updateValueAndValidity();
      this.caracteristiquesFormGroup.patchValue({ serieVoiture: '', matriculetun2: '' })
      ...
      this.caracteristiquesFormGroup.get('matriculeRS').setValidators([])
      this.caracteristiquesFormGroup.get('matriculeRS').updateValueAndValidity();
      this.caracteristiquesFormGroup.patchValue({ serieVoiture: '', numeroVoiture: '', matriculeRS: '' })
    }
  }
}